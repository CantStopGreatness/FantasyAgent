...
const SLIDES: Slide[] = [
  {
    ...
    why: (
      <>
        ...
        <Em>−5.6</Em> z-score. Points leagues pay him for the makes. Category leagues charge him
        for the misses.
      </>
    ),
  },
  {
    ...
    why: (
      <>
        ...
        win him two whole categories every week. A points league counts a three as three points
        and a steal as almost nothing.
      </>
    ),
  },
  {
    ...
    why: (
      <>
        A <Em>107-place</Em> split, driven by the category most points leagues never count. His
        3.2 turnovers a game score <Em>−2.3</Em>, and nothing else in his line pays it back.
      </>
    ),
  },
  {
